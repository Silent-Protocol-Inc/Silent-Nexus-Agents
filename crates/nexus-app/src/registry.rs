...
pub const COMMANDS: &[CommandDef] = &[
    ...
    CommandDef {
        ...
        name: "persona",
        aliases: &[],
        summary: "The active behavioral persona: create, derive, select, inspect",
        usage: "[list|create|duplicate|derive|edit|delete|select|use|off|status|inspect <id>|inspect-effective|export <id>]",
        category: CommandCategory::Session,
        interactive: true,
        non_interactive: true,
        opens_view: true,
    ...
    CommandDef {
        ...
        name: "plan",
        aliases: &[],
        summary: "Enter plan mode, or create, approve, run, replan, and export durable plans",
        usage: "[exit|create|edit|approve|run|pause|resume|replan|verify|history|export]",
        category: CommandCategory::Goals,
        interactive: true,
        non_interactive: true,
        opens_view: true,
    ...
    CommandDef {
        ...
        name: "view",
        aliases: &["activity"],
        summary: "Timeline verbosity: essential activity, detail, or diagnostics",
        usage: "[default|detailed|debug|cycle]",
        category: CommandCategory::Inspection,
        interactive: true,
        non_interactive: true,
        opens_view: false,
    ...
    CommandDef {
        ...
        name: "rsi",
        aliases: &["warp"],
        summary: "Governed self-improvement: candidates, WARP validation, promotions, governance",
        usage: "[status | candidates | show <id> | observations | outcomes | promotions | rollbacks | governance]",
        category: CommandCategory::Workspace,
        interactive: true,
        non_interactive: true,
        opens_view: true,
    ...
    CommandDef {
        ...
        name: "thinking",
        aliases: &["trace"],
        summary: "Deliberation depth and reasoning-summary visibility",
        usage: "[on|off|auto|status|toggle]",
        category: CommandCategory::System,
        interactive: true,
        non_interactive: true,
        opens_view: true,
    ...
    CommandDef {
        id: CommandId::Narrate,
        name: "narrate",
        aliases: &[],
        summary: "How much the agent says about its own work",
        usage: "[off|compact|auto|verbose|status|cycle]",
        category: CommandCategory::System,
        interactive: true,
        non_interactive: true,
        opens_view: true,
    ...
    CommandDef {
        ...
        name: "btw",
        aliases: &["note"],
        summary: "Open an aside pop-up to tell or ask the agent, separate from the main turn",
        usage: "[note or question] | --list | --clear",
        category: CommandCategory::Session,
        interactive: true,
        non_interactive: false,
        opens_view: false,
